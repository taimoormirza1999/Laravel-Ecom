                                ...
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($cart_items as $item)
                                            <tr>
                                                <td class="product_thumb"><a href="#"><img src="{{ $item->p_img }}"
                                                            alt=""></a></td>
                                                <td class="product_name"><a href="#">{{ $item->p_name }}</a></td>
                                                <td class="product-price">${{ $item->p_price }}</td>
                                                <td class="product_quantity"><label>Quantity</label> <input min="1"
                                                        max="100" value="{{ $item->quantity }}" type="number"></td>
                                                <td class="product_total">${{ $item->p_price * $item->quantity }}</td>
                                                <td class="product_remove"><a href="/cart_premove/{{ $item->id }}"><i
